...
describe("Physics", () => {
    ...
    describe("thingAbove", () => {
        ...
        it("is true when thing overlaps above", (): void => {
            ...
            physics.setMidY(thing, top);
            physics.setMidY(other, top + overlap);
        ...
        it("is false when thing is below", (): void => {
            ...
            physics.setBottom(other, bottom);
        ...
        it("is false when thing overlaps below", (): void => {
            ...
            physics.setMidY(thing, middle + overlap);
            physics.setMidY(other, middle);
    ...
    describe("thingToLeft", () => {
        ...
        it("is true when thing overlaps to the left", (): void => {
            ...
            physics.setMidX(thing, middle);
            physics.setMidX(other, middle + overlap);
        ...
        it("is false when thing overlaps to the right", (): void => {
            ...
            physics.setMidY(thing, middle);
            physics.setMidY(other, overlap);
    ...
    describe("updateBottom", () => {
        it("updates bottom", (): void => {
            ...
            const bottom = thing.bottom;
            const distance = 3.5;
            const newBottom = bottom + distance;
    ...
    describe("updateRight", () => {
        it("updates right", (): void => {
            ...
            const thing = stubThing();
            const distance = 3.5;
            const newRight = thing.right + distance;
